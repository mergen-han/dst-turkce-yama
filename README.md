...
| 4 | Bilim/üretim/skill tree/sahne | 🟡 **SCRAPBOOK %100 TAM ⭐** (4/4 batch / 690 entry); SKILLTREE+STAGEACTOR sırada |
| 5 | 17 karakter konuşmaları (62.645 string) | 🟡 DEVAM 29/314 batch (Wilson Generic %100 ✅ + Walter ACTIONFAIL+ANNOUNCE+BATTLECRY+COMBAT_QUIT+DESCRIBE_A-M) |
| 6 | Skinler + lore + vinyetler | 🟡 8/40 batch (1.503 entry) |
| 7 | QA playtest | ⬜ |
| 8 | Logo + Workshop varlıkları | ⬜ |
| 9 | v1.0 yayın | ⬜ |

**Toplam:** **17.845 / 85.706 msgid çevrildi (%20.82)** · 31 oturum (2026-04-26 → 2026-05-01) · **%20 EŞİĞİ AŞILDI ⭐⭐⭐⭐⭐⭐** · **Faz 3 %100 TAM ⭐ + SCRAPBOOK %100 TAM ⭐ + Faz 5 Wilson Generic 100% + Walter karakter başlangıç 24/314 batch + 4.800 entry — %19 EŞİĞİ AŞILDI ⭐⭐⭐⭐⭐ (DESCRIBE_A→R: ARMOR/BEEFALO/BEE/BERRY/BOAT/CARNIVAL/CHESSPIECE/COTL/CRABKING/DRAGON/DUMBBELL/FARM/FENCE/FROG/GHOSTLYELIXIR/GNARWAIL/HALLOWEEN+ORNAMENT/HERMITCRAB+TEA/HORSESHOE/ICE/KNIGHT/LAVAARENA/LIGHTNING/LUNAR/MALBATROSS/MASK 14/MAXWELL 6/MEAT/MERM/MINOTAUR/MOLE/MOLEBAT/MONKEY/MOON/MOONDIAL/MOONROCK/MOONSTORM/MOON_ALTAR/MUSHROOM 12/MUSHTREE/MUTATED/MUTATOR/NIGHTMARE/OCEANFISH/OCEANFISHING/OCEAN/OFFERING_POT/OPAL/OTTER/PALMCONE/PAVLOVA/PEPPER/PERD/PETALS/PHLEGM/PICKLEDHERRING/PIG (8 form)/PINECONE/PIRATE/PLAYBILL/POCKETWATCH 25 form Wanda/POMEGRANATE/POND/PORTABLE/POTATO/PUFFIN/PUMPKIN 8/QUAGMIRE 80+ Boğaz mutfak ekosistemi/RABBIT 2/RABBITHAT/RABBITHOLE/RABBITHOUSE/RABBITKING+HORN+SPEAR+MINION/RAINCOAT/RAINHAT/RAINOMETER 2/RATATOUILLE/RAZOR/RECORD 13 form (Spooktacular)/REDGEM/REDLANTERN/REDMOONEYE/REDPOUCH/RED_CAP+MUSHROOM/REEDS/REFINED_DUST/REFLECTIVEVEST/RELIC/RESEARCHLAB 4 tier/RESKIN_TOOL/RESURRECTIONSTATUE/RESURRECTIONSTONE/REVIVER Edgar Allan Poe/RHINODRILL/ROASTTURKEY/ROBIN+WINTER/ROBOT/ROCK/ROCKY/ROCK_AVOCADO/ROCK_ICE/ROCK_LIGHT/ROCK_MOON/ROOK/ROPE/ROPE_BRIDGE/ROSEGLASSES/ROTTENEGG/ROYAL_JELLY/RUBBLE/RUINSHAT/RUINS_BAT/SACRED_CHEST)** · **%15 EŞİĞİ AŞILDI** ⭐⭐⭐. Detaylı durum: [`PROGRESS.md`](PROGRESS.md).
...
**Sahip:** [@aydincol4k](https://github.com/aydincol4k) · **Build:** DST `722900` · **Sürüm:** `0.9.4-wilson-describe-fm`
